        ...
        <div className="flex w-full flex-col gap-2 px-1 pb-4 md:gap-4">
          ...
          <div className="flex justify-end gap-2 border-t border-border-medium pt-2 md:pt-4">
            ...
            <button
              ...
              className="rounded-md bg-blue-600 px-3 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 md:px-4"
            >
