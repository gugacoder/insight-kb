    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-end">
        <button
          onClick={saveMCP}
          disabled={isLoading}
          className="focus:shadow-outline mt-1 flex min-w-[100px] items-center justify-center rounded bg-blue-600 px-4 py-2 font-semibold text-white hover:bg-blue-500 focus:border-blue-500 focus:outline-none focus:ring-0 disabled:bg-blue-400"
          type="button"
        >
          {(() => {
            if (isLoading) {
