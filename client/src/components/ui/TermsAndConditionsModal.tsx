        ...
        buttons={
          <>
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-lg border border-border-heavy bg-surface-submit px-4 py-2 text-sm text-white hover:bg-surface-submit-hover focus:bg-surface-submit-hover"
            >
